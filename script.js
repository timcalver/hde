...
$('#team').click(function(){
  if($(window).width()<600){
    $("html, body").animate({ scrollTop: ($(window).height()*2+($(window).height()/2))}, 600);
  }else{
    $("html, body").animate({ scrollTop: ($(window).height()*2+($(window).height()/10))}, 600);
...
$('#utility').click(function(){
  if($(window).width()<400){
    $("html, body").animate({ scrollTop: ($(window).height()*3+($(window).height()*1.3))}, 600);
  }else if($(window).width()<600){
    $("html, body").animate({ scrollTop: ($(window).height()*4+($(window).height()/12))}, 600);
  }else{
    $("html, body").animate({ scrollTop: ($(window).height()*3+($(window).height()/3))}, 600);
  }
    $('.menu__icon, .menu__bar, .menu__body').toggleClass("active")
    return false;
});
$('#faq').click(function(){
  if($(window).width()<400){
    $("html, body").animate({ scrollTop: ($(window).height()*6+($(window).height()))}, 600);
  }else if($(window).width()<600){
    $("html, body").animate({ scrollTop: ($(window).height()*5+($(window).height()/2.5))}, 600);
  }else{
    $("html, body").animate({ scrollTop: ($(window).height()*4+($(window).height()/4))}, 600);
  }
    $('.menu__icon, .menu__bar, .menu__body').toggleClass("active")
    return false;
});
